...
Config.Placeables = {
    ...
    Items = {
        ...
        -- grow_light disabled for now (glow-light behaviour not ready)
        -- grow_light = {
        --     label              = 'Grow Light',
        ...
        weed_bench = {
            ...
            -- Adds a "Use Work Bench" ox_target option on the placed bench that
            -- opens the Rolling Station (buds + papers -> joints), so the bench is
            -- a functional crafting station, not just a pickup-able prop.
            openRolling        = true,
        },
    },
